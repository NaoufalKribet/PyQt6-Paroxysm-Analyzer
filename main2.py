...
class MainWindow(QMainWindow):
    ...
    def create_training_tab(self):
        ...
        self.model_type_combo = QComboBox(); self.model_type_combo.addItems(["Simple Threshold","Neural Network", "Random Forest", "LightGBM", "K-Nearest Neighbors (KNN)"]); model_selection_layout.addRow("Algorithme :", self.model_type_combo)
        ...
        threshold_form = QFormLayout(threshold_panel)
        threshold_form.addRow(QLabel("Ce modèle n'a pas d'hyperparamètres.\nLe seuil est optimisé automatiquement."))
        ...
        self.params_stack.addWidget(threshold_panel); self.params_stack.addWidget(nn_panel); self.params_stack.addWidget(rf_panel); self.params_stack.addWidget(lgbm_panel); self.params_stack.addWidget(knn_panel)
